...
describe('favoriteBlog', () => {
    ...
    test('when list has one blog, returns blog', () => {
...
describe('mostBlogs', () => {
  ...
  test('when list has one blog, returns that blogs author and 1 blog', () => {
...
describe('mostLikes', () => {
  ...
  test('when list has multiple blogs, returns author with most likes and number of likes', () => {
    expect(listHelper.mostLikes(blogs)).toEqual({ author: "Edsger W. Dijkstra", likes: 17 })
  })
  
  test('when list has one blog, returns that blogs author and number of likes of that blog', () => {
